...
class AdminOmnivaOrdersController extends ModuleAdminController
{
	...
	public function initContent()
	{
        ...
        $this->context->smarty->assign(array(
			...
			'requestPage' => $this->context->link->getAdminLink('AdminOmnivaOrders', true),
			'current_url' => $this->context->link->getAdminLink('AdminOmnivaOrders', true),
			'requestNb' => $this->context->link->getAdminLink('AdminOmnivaOrders', true),
			'p' => $page,
			'n' => 3,
			'start' => $startGroup,
			'stop' => $endGroup,
	...
	public function getOrders($page = 1, $perPage = 10, $total = 0) 
	{
		...
		WHERE k.omnivalt_manifest IS NOT NULL AND k.omnivalt_manifest<>".$newOrder."
